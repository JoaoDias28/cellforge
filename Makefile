...
.PHONY: lint test validate-examples kit-extension-check ros-build ros-test
...
lint:
	...
	$(UV) run --frozen mypy --explicit-package-bases src/kit/cellforge.studio/cellforge/studio/application.py src/kit/cellforge.studio/cellforge/studio/backend.py src/kit/cellforge.studio/tests
